...
<template>
  <div class="min-h-screen bg-slate-50 font-sans pb-20" @click="closeFilter">
    ...
    <main class="max-w-6xl mx-auto px-6 mt-12">
      ...
      <!-- ── FILTER & SORT BAR ── -->
      <div class="flex items-center justify-between gap-3 mb-10 animate-[fadeIn_0.8s_ease-out]">
        ...
        <div class="flex items-center gap-2">
          ...
          <select
            v-model="sortOrder"
            @click.stop
            class="bg-white border-2 border-slate-200 text-slate-700 font-bold text-sm px-3 py-2 rounded-xl outline-none focus:border-emerald-400 cursor-pointer transition"
          >
          ...
          <div class="relative" @click.stop>
            <button
              ...
              class="flex items-center gap-2 px-4 py-2 rounded-xl font-bold text-sm border-2 transition-all"
        ...
        >
          <div class="h-48 bg-emerald-50 relative overflow-hidden flex-shrink-0">
            ...
            <div class="absolute bottom-4 left-4">
              <!-- Badge Kategori -->
              <span class="bg-yellow-400 text-yellow-900 text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-full shadow-sm">
                {{ mat.category || 'Umum' }}
              </span>
            </div>
          </div>
